...
Enclave_Include_Paths := -Iinclude -Ienclave -I$(SGX_SDK)/include -I$(SGX_SDK)/include/tlibc -I$(SGX_SDK)/include/libcxx -I$(SGX_SDK)/include/stdc++ -Ienclave/libs/secp256k1 -Ienclave/libs/secp256k1/include -Ienclave/libs/sha3 -Ienclave/libs/rlp
