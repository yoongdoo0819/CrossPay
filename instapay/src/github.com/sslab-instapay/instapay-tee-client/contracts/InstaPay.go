...
//
// Solidity: function channels(uint256 ) view returns(address owner, address receiver, uint256 deposit, uint8 status)
func (_Instapay *InstapayCaller) Channels(opts *bind.CallOpts, arg0 *big.Int) (struct {
	...
	outstruct.Deposit = out[2].(*big.Int)
...
//
// Solidity: function ejections(uint256 ) view returns(bool registered, uint8 stage)
func (_Instapay *InstapayCaller) Ejections(opts *bind.CallOpts, arg0 *big.Int) (struct {
	...
	outstruct.Registered = out[0].(bool)
	outstruct.Stage = out[1].(uint8)
...
//
// Solidity: function readme() view returns(uint256)
...
//
// Solidity: function create_channel(address receiver) payable returns()
