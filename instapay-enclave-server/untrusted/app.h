...
void ecall_cross_create_confirm_msg_w(unsigned int payment_num, unsigned int payment_size, unsigned int *channel_ids, int *amont, unsigned char **original_msg, unsigned char **output);
